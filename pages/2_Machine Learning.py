...
if uploaded_file is not None:
    ...
    with modification_container:
        ...
        player1 = st.selectbox("Player 1", df_pred[df_pred.Location==location].Player1.unique())
        player2 = st.selectbox("Player 2", df_pred[df_pred.Location==location].Player2.unique())
